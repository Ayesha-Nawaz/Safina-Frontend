...
export const eventSignificance = {
  english: {
    ...
    "Ashura": "Ashura holds dual significance: it commemorates the day Allah saved Prophet Musa (Moses) and the Israelites from Pharaoh, and for Shia Muslims, it marks the martyrdom of Imam Hussain at Karbala, symbolizing the struggle against injustice and oppression.",
  ...
  urdu: {
    ...
    "Ashura": "عاشورہ دو وجوہات سے اہم ہے: اس دن اللہ نے حضرت موسیٰ اور ان کی قوم کو فرعون سے بچایا تھا۔ شیعہ مسلمانوں کے لیے، یہ وہ دن ہے جب امام حسین شہید ہوئے تھے۔ یہ دن ہمیں سکھاتا ہے کہ ہمیشہ صحیح کام کرنا چاہیے۔",
