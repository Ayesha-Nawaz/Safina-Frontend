...
const AsmaUlHusnaComp: React.FC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        console.log("Fetching from:", `${BASE_URL}/asmaulnabi/names`); // 🔍 Log API URL
        const response = await axios.get(`${BASE_URL}/asmaulnabi/names`);
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.headerText}>✨Beautiful Names of Prophet Muhammad✨</Text>
      <FlatList
